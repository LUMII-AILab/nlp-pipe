...
let sampleTexts = [
    ...
    [
        'Lielbritānijas \'British Steel\'',
        `Lielbritānijas 'British Steel' vēlas iegādāties visu 'KVV Liepājas metalurgu'
...
"Lidl" Somijas meitasuzņēmuma vadītājs Lauri Siponens pērn septembrī somu medijiem pauda, ka veikals Latvijā un Igaunijā varētu ienākt nākamajā desmitgadē, proti, ne ātrāk par 2020. gadu.`
    ...
    [
        'Phjončhana 2018',
        `Gaidot 'Phjončhanu 2018': Kanādas olimpiskā hokeja izlase ceļu pēc zelta sāk Latvijā
...
Kanādas hokeja izlases sastāvs dalībai Phjončhanas olimpiskajās spēlēs:
vārtsargi: Bens Skrīvenss ("Salavat Julajev", KHL), Džastins Pīterss ("Koln", Vācija), Kevins Pulens ("Medveščak", Horvātija)

aizsargi: Stefans Eliots ("HV-71", Zviedrija), Čejs Genovejs ("Lada", KHL), Kodijs Golubefs ("Stockton Heat", AHL), Marks Andrē Granjāni (Minskas "Dinamo", KHL), Kriss Lī (Magņitogroskas "Metallurg", KHL), Maksims Noro ("SC Bern", Šveice), Mets Robinsons (Maskavas CSKA, KHL), Karls Stolerijs (Rīgas "Dinamo", KHL)

uzbrucēji: Renē Burks ("Djurgardens", Zviedrija), Žilbērs Brilē ("Kuņluņ Red Star", KHL), Endrjū Ebets ("SC Bern", Šveice), Kvintons Houdens (Minskas "Dinamo", KHL), Kriss Kelijs, Robs Klinkhammers (abi "Ak Bars", KHL), Brendons Kozuns ("Lokomotiv", KHL), Maksims Lapjērs ("Lugano", Šveice), Ēriks O'Dells ("Soči", KHL), Meisons Reimonds ("SC Bern", Šveice), Dereks Ruā ("Linkopings", Zviedrija), Kristians Tomass ("Wilkes-Barre/Scranton Penguins", AHL), Voiteks Voļskis (Magņitogorskas "Metallurg", KHL), Lindens Vejs ("Baris", KHL).`
    ],
    [
        'Pāreja uz mācībām latviešu valodā',
        `Saeimā sākas virzība grozījumiem par pakāpenisku pāreju uz mācībām latviešu valodā
...
Savukārt deputāts Igors Pimenovs (S) aicināja neatbalstīt šādas izmaiņas, uzsverot, ka šis ir otrais mazākumtautību mācību latviskošanas vilnis. Pimenovs norādīja uz pieprasījumu pēc izglītības krievu valodā, kā arī uzsvēra, ka vecākiem ir pamatotas tiesības prasīt, lai no viņu samaksātajiem nodokļiem tiktu nodrošinātas apmācības arī mazākumtautību valodās.
 ...
 Krievu skolu aizstāvji sola rīkot referendumu par mazākumtautību skolu autonomiju
...
const NlpView = () => {
  ...
  const [steps, setSteps] = useState(['tokenizer', 'morpho', 'parser', 'ner']);
  ...
  return (
    <div className="demo-container">
      ...
      <Input.TextArea value={text} onChange={e => setText(e.target.value)} rows={6} style={{marginBottom: 10}}/>
